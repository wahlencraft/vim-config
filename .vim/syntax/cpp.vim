...
" Added by me
syn keyword cppContainer array vector deque forward_list list set multiset map multimap unordered_set unordered_multiset unordered_map unordered_multimap stack queue priority_queue string u16string u32string wstring
hi def link cppContainer cppType
