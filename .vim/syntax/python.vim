...
if s:Enabled('g:python_highlight_func_calls')
    ...
    syn match pythonFunctionCall '\h\w*\ze\s*('
endif

" My definition
syn match pythonAttribute '\.\zs\s*\h\w*' contains=pythonFunctionCall
...
"syn match   pythonDot        '\.' display containedin=pythonDottedName,pythonTest
" breaks pythonAttribute
