...
autocmd FileType sh,cpp,c,arm,python,lua,tex setlocal termguicolors
...
call s:HLBold('texMathZoneC', s:clr.gruvbox_red)
call s:HLBold('texMathMatcher', s:clr.gruvbox_red)
call s:HLBold('texMathOper', s:clr.gruvbox_yellow)
